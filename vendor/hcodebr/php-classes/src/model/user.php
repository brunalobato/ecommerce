...
class User extends model {
    ...
    public function  save() {
      ...
      $results = $sql->select("CALL sp_users_save(:desperson, :deslogin, :despassword, :desemail, :nrphone, :inadmin)", array(
            ...
            ":despassword"=>User::getPersswordHash($this->getdespassword()),
    ...
    if (count($results) === 0)
    {
        throw new \Exception("Não foi possivél recuperar a senha");
    }
    ...
    public static function validForgotDecrypt($code)
    {
      ...
      $results =  $sql->select(" SELECT *
       ...
       public static function getPageSearch($search, $page = 1, $itemsPerPage = 10)
       {
          ...
          $results =  $sql->select("SELECT SQL_CALC_FOUND_ROWS *
           FROM tb_users a INNER JOIN tb_persons b USING(idperson) WHERE b.desperson LIKE :search OR b.desemail = :search
